...
CREATE USER aioptimization WITH PASSWORD 'aioptimization';

-- Grant all privileges on the database
GRANT ALL PRIVILEGES ON DATABASE aioptimization TO aioptimization;

-- Grant schema permissions
GRANT USAGE ON SCHEMA public TO aioptimization;
GRANT CREATE ON SCHEMA public TO aioptimization;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO aioptimization;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO aioptimization;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO aioptimization;

-- Set default privileges
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO aioptimization;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO aioptimization;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON FUNCTIONS TO aioptimization;
